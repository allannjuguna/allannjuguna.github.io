...
tags:
  ...
  - CasaOs
  - RCE
image: "/images/CasaOs/Pasted_20241009150352.png"
author: "zerofrost"
draft: false
---
...
Visiting the URL we come across a registration page, pretty standard stuff. Create an account and you are set to go, I chose the credentials `casaos:casaos` here. 
![](/images/CasaOs/Pasted_20241027120520.png)
#### Dashboard
After successful installation and login, you can now access the main dashboard which contains some metrics about the underlying host such as the CPU usage, RAM usage, utilized storage, network status and available interfaces, customizable widget settings, as well as the App Store, File Manager and installed applications.
